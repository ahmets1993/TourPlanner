...
public class UpdatePanelController implements Initializable {
    ...
    void onUpdateButtonClicked(ActionEvent event) throws IOException {
        ...
        UpdatePanelViewModel updatePanelViewModel = new UpdatePanelViewModel();
        updatePanelViewModel.updateTourByID(date, time, duration,price, ID);


        //What is going on here...Look at after
